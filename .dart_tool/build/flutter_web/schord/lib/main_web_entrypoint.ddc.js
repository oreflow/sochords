define(['dart_sdk', 'packages/schord/main'], function(dart_sdk, packages__schord__main) {
  'use strict';
  ...
  const main = packages__schord__main.main;
  ...
  dart.trackLibraries("packages/schord/main_web_entrypoint", {
    "package:schord/main_web_entrypoint.dart": main_web_entrypoint
  }, {

define(['dart_sdk'], function(dart_sdk) {
  ...
  const fixnum = Object.create(dart.library);
  ...
  dart.defineLazy(CT, {
    ...
    get C13() {
      return C13 = dart.constList([0, 0, 1048576, 531441, 1048576, 390625, 279936, 823543, 262144, 531441, 1000000, 161051, 248832, 371293, 537824, 759375, 1048576, 83521, 104976, 130321, 160000, 194481, 234256, 279841, 331776, 390625, 456976, 531441, 614656, 707281, 810000, 923521, 1048576, 35937, 39304, 42875, 46656], core.int);
    }
  });
  ...
  dart.setLibraryUri(fixnum.IntX, "package:fixnum/fixnum.dart");
  const _i = dart.privateName(fixnum, "_i");
  const _toInt = dart.privateName(fixnum, "_toInt");
  const Int32__i = dart.privateName(fixnum, "Int32._i");
  let C0;
  let C1;
  let C2;
  let C3;
  ...
  dart.setLibraryUri(fixnum.Int32, "package:fixnum/fixnum.dart");
  ...
  const _l = dart.privateName(fixnum, "_l");
  const _m = dart.privateName(fixnum, "_m");
  const _h = dart.privateName(fixnum, "_h");
  const Int64__h = dart.privateName(fixnum, "Int64._h");
  const Int64__m = dart.privateName(fixnum, "Int64._m");
  const Int64__l = dart.privateName(fixnum, "Int64._l");
  let C6;
  const _compareTo = dart.privateName(fixnum, "_compareTo");
  const _toRadixString = dart.privateName(fixnum, "_toRadixString");
  const _hexDigit = dart.privateName(fixnum, "_hexDigit");
  let C7;
  let C8;
  let C9;
  let C10;
  ...
  fixnum.Int64 = class Int64 extends core.Object {
    ...
    static _toRadixStringUnsigned(radix, d0, d1, d2, sign) {
      ...
      while (!(d4 === 0 && d3 === 0)) {
        ...
        d0 = q;
        if (!(chunk3 === "")) dart.assertFailed(null, "org-dartlang-app:///packages/fixnum/src/int64.dart", 742, 14, "chunk3 == \"\"");
        chunk3 = chunk2;
        chunk2 = chunk1;
    ...
    static _divideHelper(a0, a1, a2, aNeg, b0, b1, b2, bNeg, what) {
      ...
      if (b2 === 0 && b1 === 0 && dart.notNull(b0) < (1)[$leftShift](30 - 22)) {
        ...
        q1 = q1d[$toInt]();
        q0 = q0d[$toInt]();
        if (!(q0 + 4194304 * q1 + 17592186044416.0 * q2 === (ad / bd)[$floorToDouble]())) dart.assertFailed(null, "org-dartlang-app:///packages/fixnum/src/int64.dart", 936, 14, "q0 + K1 * q1 + K2 * q2 == (ad / bd).floorToDouble()");
        if (!(q2 === 0 || b2 === 0)) dart.assertFailed(null, "org-dartlang-app:///packages/fixnum/src/int64.dart", 937, 14, "q2 == 0 || b2 == 0");
        ...
        if (!(p2d <= 1048575)) dart.assertFailed(null, "org-dartlang-app:///packages/fixnum/src/int64.dart", 948, 14, "p2d <= _MASK2");
      ...
      if (!dart.test(fixnum.Int64.ZERO['<='](new fixnum.Int64._bits(r0, r1, r2)))) dart.assertFailed(null, "org-dartlang-app:///packages/fixnum/src/int64.dart", 984, 12, "Int64.ZERO <= Int64._bits(r0, r1, r2)");
      if (!(r2 < dart.notNull(b2) || dart.test(new fixnum.Int64._bits(r0, r1, r2)['<'](new fixnum.Int64._bits(b0, b1, b2))))) dart.assertFailed(null, "org-dartlang-app:///packages/fixnum/src/int64.dart", 985, 12, "r2 < b2 || // Handles case where B = -(MIN_VALUE)\n        Int64._bits(r0, r1, r2) < Int64._bits(b0, b1, b2)");
      if (!(what === 1 || what === 3 || what === 2)) dart.assertFailed(null, "org-dartlang-app:///packages/fixnum/src/int64.dart", 988, 12, "what == _RETURN_DIV || what == _RETURN_MOD || what == _RETURN_REM");
      if (what === 1) {
  ...
  dart.setLibraryUri(fixnum.Int64, "package:fixnum/fixnum.dart");
